...
def test_extract_all_message_timestamps():
    ...
    messages = [
        QueuedMessage(text="msg1", slack_ts="1234567890.123456", thread_ts=None),
        QueuedMessage(text="msg2", slack_ts="1234567891.123456", thread_ts=None),
        QueuedMessage(text="msg3", slack_ts="1234567892.123456", thread_ts=None),
    ]
...
def test_get_primary_thread_ts_with_thread():
    ...
    messages = [
        QueuedMessage(text="msg1", slack_ts="1234567890.123456", thread_ts=None),
        QueuedMessage(text="msg2", slack_ts="1234567891.123456", thread_ts="1234567890.000000"),
        QueuedMessage(text="msg3", slack_ts="1234567892.123456", thread_ts="1234567890.000000"),
    ]
